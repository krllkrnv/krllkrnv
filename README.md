# 💫 About Me:
👋 Привет! Я фронтенд-разработчик с фокусом на Vue.js.<br>💻 Люблю создавать красивые, интуитивно понятные и производительные веб-приложения.<br>🚀 В своей работе я уделяю внимание качеству кода, оптимизации и современным подходам в разработке.
